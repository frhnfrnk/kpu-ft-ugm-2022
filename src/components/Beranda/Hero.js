    ...
    <>
      {/*Hero Section Start*/}
        <div className="bg-[#E1DAD1] h-full">
          <div className="bg-cover bg-center w-full h-screen bg-no-repeat" style={{ backgroundImage: "url(" + Back_kertas + ")" }}>
            <div className="grid lg:grid-cols-12 lg:pl-[170px]">
              <div className="flex flex-col lg:col-span-5 lg:col-start-1 lg:pt-40 pt-28 gap-2 lg:text-left lg:mx-0 mx-auto">
                ...
                <div className="mt-4 space-x-4">
                  <button href="#" className="bg-gradient-to-r from-[#8A2D2D] to-[#6E2424] text-[#FFFFFF] rounded-full px-4 py-2 font-semibold shadow-[0px_4px_10px_rgba(55,18,18,0.25)]">Vote Sekarang!</button>
                  <button href="#" className="border-[#A05252] border-2 rounded-full px-7 py-1.5 text-[#A05252] font-semibold">Lihat Calon</button>       
                </div>         
              </div>
              <div className="lg:col-span-7 lg:col-start-6 lg:pt-28 pt-16 pb-36 lg:pr-[95px] mx-12 lg:mx-0">
